...
files = list.files("/home/dsamaddar/Downloads/data 2/wm_ntgtvsbl/")
...
GM_mask = readnii("/home/dsamaddar/Documents/CCAR3/experiments/data/fMRI-data/data/gm_mask020_bin.nii.gz")
GM.d = GM_mask@.Data
GM.d <- reshape2::melt(GM.d)
colnames(GM.d)<- c("x", "y", "z", "GM")

setwd("/home/dsamaddar/Documents/CCAR3")
atlas800 = readnii("/home/dsamaddar/Documents/CCAR3/experiments/data/fMRI-data/data/atlases/Schaefer2018_200Parcels_7Networks_order_FSLMNI152_2mm.nii.gz")
...
for(file in files){
  print(file)
  t1 = readnii(paste0("/home/dsamaddar/Downloads/data 2/wm_ntgtvsbl/", file))
  test = t1@.Data
  test[is.na(test)] = 0
...
node_name = read_table("/home/dsamaddar/Documents/group-CCA/experiments/real-data/fMRI-data/Schaefer2018_200Parcels_7Networks_order.txt",
